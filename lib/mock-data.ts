import type { Benefit, MiniCourse, TrainingVideo } from "./types";
...
export const videos: TrainingVideo[] = [
  {
    ...
    image: "/images/running.svg", imageAlt: "Atleta durante una sessione di corsa ad alta intensità", accent: "orange",
  ...
  },
  {
    ...
    image: "/images/mobility.svg", imageAlt: "Atleta che esegue un esercizio di mobilità", accent: "violet",
  ...
  },
  {
    ...
    image: "/images/strength.svg", imageAlt: "Atleta in allenamento funzionale per il core", accent: "lime",
  ...
  },
  {
    ...
    image: "/images/recovery.svg", imageAlt: "Atleta in una posizione rilassata di recupero", accent: "sand",
  ...
  },
  {
    ...
    image: "/images/cycling.svg", imageAlt: "Ciclista impegnato in una salita", accent: "blue",
  ...
  },
  {
    ...
    image: "/images/strength.svg", imageAlt: "Atleta durante un allenamento total body", accent: "lime",
  ...
  },
  {
    ...
    image: "/images/swimming.svg", imageAlt: "Nuotatore durante una sessione tecnica in piscina", accent: "blue",
  ...
  },
  {
    ...
    image: "/images/tennis.svg", imageAlt: "Tennista che lavora sugli spostamenti in campo", accent: "orange",
  ...
  },
  {
    ...
    image: "/images/mobility.svg", imageAlt: "Atleta in una sequenza yoga per la mobilità", accent: "violet",
  ...
  },
  {
    ...
    image: "/images/running.svg", imageAlt: "Atleta durante ripetute ad alta intensità", accent: "orange",
  ...
  },
  {
    ...
    image: "/images/recovery.svg", imageAlt: "Atleta che esegue stretching in un ambiente tranquillo", accent: "sand",
  ...
  },
  {
    ...
    image: "/images/cycling.svg", imageAlt: "Ciclista durante un allenamento di resistenza", accent: "blue",
...
export const courses: MiniCourse[] = [
  {
    ...
    image: "/images/running.svg", imageAlt: "Runner su una pista durante un allenamento tecnico",
    lessons: [
  ...
  },
  {
    ...
    image: "/images/strength.svg", imageAlt: "Atleta che allena la forza con esercizi funzionali",
    lessons: [
  ...
  },
  {
    ...
    image: "/images/recovery.svg", imageAlt: "Atleta durante una sessione guidata di recupero",
    lessons: [
