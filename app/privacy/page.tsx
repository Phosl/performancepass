...
const sections = [
  ...
  { title: "Cookie e servizi esterni", content: "La demo non utilizza cookie pubblicitari, strumenti di profilazione o analytics di terze parti. Le fotografie di atletica sono asset originali ospitati localmente nel progetto." },
